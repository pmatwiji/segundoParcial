    ...
    if(this != NULL && (nodeIndex >= 0 && nodeIndex <= ll_len(this)))
    {
        ...
        if (newNode != NULL)
        {
            ...
            else
            {
                ...
                newNode->pNextNode = pAuxNode->pNextNode;
                pAuxNode->pNextNode = newNode;
...
int ll_remove(LinkedList* this,int index)
{
    ...
    if(this != NULL && index >= 0 && index <= ll_len(this))
    {
        ...
        if(pNode != NULL)
        {
            ...
            {
                previousNode->pNextNode = getNode(this, index+1);
            }
...
LinkedList* ll_subList(LinkedList* this,int from,int to)
{
    ...
    if(this != NULL &&(from >= 0 && from < ll_len(this) && (to > from && to <= ll_len(this))))
    {
        ...
        if(cloneArray != NULL)
        {
            for(i = from; i <= to; i++)
            {
                newElement = ll_get(this,i);
                ll_add(cloneArray,newElement);
            }
        }
    }
    ...
    if(this != NULL && pFunc != NULL && (order == 0 || order == 1))
    {
        do
        {
            ...
            for(i = 0; i<ll_len(this); i++)
            {
                ...
                previousElement = ll_get(this, i +1);

                if(pElement != NULL && previousElement != NULL)
                {
                    sort = pFunc(pElement,previousElement);
